...
public class HealthCollector {
    ...
    public static void main(String[] args) {
        ...
        if (consultantsFileExist) {
            ...
            System.out.println(
                    appResourceBundle.getString("Consultant") + ": " + appResourceBundle.getString("NoDatabaseFound"));
        }
        ...
        if (patientsFileExist) {
            ...
            System.out.println(
                    appResourceBundle.getString("Patient") + ": " + appResourceBundle.getString("NoDatabaseFound"));
        }
        ...
        if (measurementsFileExist) {
            ...
            System.out.println(appResourceBundle.getString("Measurements") + ": "
                    + appResourceBundle.getString("NoDatabaseFound"));
        }
        ...
        if (patientsFileExist & consultantsFileExist & measurementsFileExist) {
            ...
            for (Consultant consultant : consultants.getAll()) {
                System.out
                        .println(appResourceBundle.getString("Using") + " " + appResourceBundle.getString("Consultant")
                                + ": " + consultant.getName() + " " + consultant.getSurname());
                for (Patient patient : patients.getAll()) {
                    System.out
                            .println(appResourceBundle.getString("Using") + " " + appResourceBundle.getString("Patient")
                    ...
                    measurements.add(new Measurement(patient, consultant, date,
                            Utils.round2digits(50 + 60 * Math.random()), Utils.round2digits(50 + 150 * Math.random()),
                            Utils.round2digits(50 + 100 * Math.random())));
                }
            }
            ...
            System.out.println(appResourceBundle.getString("Measurements") + ": "
                    + appResourceBundle.getString("WritingListToFile") + " " + measurementsFile);
            measurements.writeToDisk(measurementsFile);

            System.out.println(appResourceBundle.getString("Consultant") + ": "
                    + appResourceBundle.getString("WritingListToFile") + " " + consultantsFile);
            consultants.writeToDisk(consultantsFile);

            System.out.println(appResourceBundle.getString("Patient") + ": "
                    + appResourceBundle.getString("WritingListToFile") + " " + patientsFile);
            ...
            System.out.println(
                    appResourceBundle.getString("Patient") + ": " + appResourceBundle.getString("AddingEntries"));
            ...
            System.out.println(
                    appResourceBundle.getString("Measurements") + ": " + appResourceBundle.getString("AddingEntries"));
            for (Consultant consultant : consultants.getAll()) {
                System.out
                        .println(appResourceBundle.getString("Using") + " " + appResourceBundle.getString("Consultant")
                                + ": " + consultant.getName() + " " + consultant.getSurname());
